...
const AddProducts = ({ route }) => {
  ...
  hMetalWt!=0||GrossWt1!=undefined ? VeryFy1():null;
    getProductPrice();
                ...
                <View
                  ...
                  <Dropdown
                    ...
                    selectedTextStyle={[
                      ...
                      { fontSize: 15, fontWeight: '700', color: '#000', marginLeft: 10 },
                    ]}
                    ...
                    itemTextStyle={{ fontSize: 15, fontWeight: '700', color: 'red' }}         
                  />
                </View>
              </TouchableOpacity>
            )}
