...
const MyProducts = ({route}) => {
  ...
  const share = async items => {
    await Share.share({
      message: `Product Name : ${items.ItemName} \nProduct Price : ${
        items?.ProductCharges == null ? 0 : items?.ProductCharges
      } \n Product Description : ${items.ItemDesc}`,
    });
  };
  return (
    <View style={styles.container}>
      ...
      {WishList?.wishlistitems?.length == 0 || WishList?.wishlistitems?.length==undefined ?(
        <View
          style={{
            ...
            <View style={styles.main}>
              <View>
                <Text style={styles.text}>
                  {WishList?.wishlistitems?.length == 1
                    ? `${WishList?.wishlistitems?.length} Item`
                    ...
                    <View
                      ...
                      <View
                        ...
                        <Image
                          ...
                          source={
                            item.ImageName
                              ? {uri: `${WishList.imagepath}${item.ImageName}`}
                      ...
                      <View
                        ...
                        <View style={styles.cardbottom1}>
                          ...
                          <Text style={styles.cardbottom1text}>
                            {parseFloat(item.ProductsPrice)?.toFixed(2)}
                          </Text>
                        </View>
                      </View>
                    </View>
