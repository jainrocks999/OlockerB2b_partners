...
const DiamondViewModal = ({
  ...
  const validateInputs = () => {
    if (inputs.Diamondwt == '') {
      ...
      return;
    } else if (inputs.ChargAmt == '' && isBrekup == 0) {
            ...
            <ScrollView
              ...
              <View style={styles.modalText}>
                ...
                <View style={{width: wp(60)}}>
                  <Text style={styles.deta}>
                    (DETAILS OF PRECIOUS Diamond S USED IN PRODUCT)
                  </Text>
                </View>
              </View>
                        ...
                        return (
                          <View
                            ...
                            <View style={[styles.cartItem, {marginTop: wp(5)}]}>
                              <Text
                                style={[styles.cardTitle, {color: 'black'}]}>
                                Diamond Name
                              </Text>

                              <Text style={[styles.cardTitle, styles.dot]}>
                                :
                              </Text>
                              <Text
                                style={[styles.cardTitle, {color: 'black'}]}>
              ...
              <View style={{marginLeft: wp(1)}}>
                <Text style={styles.buttonClose}>
                  Diamond weight <Text style={{color: 'red'}}>*</Text>
                </Text>
              ...
              <View
                style={[
                  styles.inputFiled,
                  {marginLeft: wp(1), paddingHorizontal: 10},
                ]}>
                <Dropdown
                  style={{
                    color: '#032e63',
