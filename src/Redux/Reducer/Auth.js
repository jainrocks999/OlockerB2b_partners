...
export default (state = initialstate, action) => {
  switch (action.type) {
    ...
    case 'User_collectionProductViewList_Request':
      return {...state, isFetching: true};
    case 'User_collectionProductViewList_Success':
      return {...state, isFetching: false, CollectionProduct: action.payload};
    case 'User_collectionProductViewList_Error':
    ...
    case 'product_verifyWt_Success':
      return {...state, isFetching: false, VeryFy: action.payload};
    ...
    case 'User_categories_Success':
      return {...state, isFetching1: false, Categories: action.payload};
